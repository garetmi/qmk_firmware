...
#define ICON_MED_WPM     40           // WPM required to display the medium snail
...
#define MA_LAYER_NAME     "MAIN "      // Layer _MA name
#define L1_LAYER_NAME     "osu! "      // Layer _L1 name
#define L2_LAYER_NAME     "MacOS"      // Layer _L2 name
#define L3_LAYER_NAME     "MUSIC"      // Layer _L3 name

#define CAPLCK_STR        "CAPS "       // Caps Lock string
#define NUMLCK_STR        "NUM  "       // Num Lock string
#define SCRLK_STR         "SCROL"       // Scroll Lock string
...
static void render_led_status(void) {
    ...
    oled_write_P(led_state.scroll_lock ? PSTR(SCRLK_STR) : PSTR("18302"), false);
}
